<?php 
    ...
    $sqlprod="SELECT * FROM laptop";

    $sql1="SELECT * FROM laptop WHERE product_id='{$prod1}'";
    $result1=mysqli_query($conn,$sql1);
    $row1=mysqli_fetch_assoc($result1);
    $img1="images/{$prod1}.png";
    $link1="product.php?productid={$prod1}";

    $sql2="SELECT * FROM laptop WHERE product_id='{$prod2}'";
    $result2=mysqli_query($conn,$sql2);
    $row2=mysqli_fetch_assoc($result2);
    $img2="images/{$prod2}.png";
    $link2="product.php?productid={$prod2}";

    $sql3="SELECT * FROM laptop WHERE product_id='{$prod3}'";
    ...
    <main>   
        ...
        <div class="dropdown">
            ...
            <div class="content">
                ...
                if($prod2==NULL && $prod3==NULL)
                    $link="comparepc.php?product1={$row["product_id"]}";
                else if($prod2!=NULL && $prod3==NULL)
                    $link="comparepc.php?product1={$row["product_id"]}&product2={$prod2}";
                else if($prod2==NULL && $prod3!=NULL)
                    $link="comparepc.php?product1={$row["product_id"]}&product3={$prod3}";
                else
                    $link="comparepc.php?product1={$row["product_id"]}&product2={$prod2}&product3={$prod3}";
                ?>
        ...
        <div class="dropdown">
            ...
            <div class="content">
                ...
                if($prod1==NULL && $prod3==NULL)
                    $link="comparepc.php?product2={$row["product_id"]}";
                else if($prod1!=NULL && $prod3==NULL)
                    $link="comparepc.php?product1={$prod1}&product2={$row["product_id"]}";
                else if($prod1==NULL && $prod3!=NULL)
                    $link="comparepc.php?product2={$row["product_id"]}&product3={$prod3}";
                else
                    $link="comparepc.php?product1={$prod1}&product2={$row["product_id"]}&product3={$prod3}";
                ?>
                    <a href=<?php echo $link;?>><?php echo $row["product_name"];?></a>
                <?php
                }
        ...
        <div class="dropdown">
            ...
            <div class="content">
                ...
                if($prod1==NULL && $prod2==NULL)
                    $link="comparepc.php?product3={$row["product_id"]}";
                else if($prod1!=NULL && $prod2==NULL)
                    $link="comparepc.php?product1={$prod1}&product3={$row["product_id"]}";
                else if($prod1==NULL && $prod2!=NULL)
                    $link="comparepc.php?product2={$prod2}&product3={$row["product_id"]}";
                else
                    $link="comparepc.php?product1={$prod1}&product2={$prod2}&product3={$row["product_id"]}";
                ?>
                    <a href=<?php echo $link;?>><?php echo $row["product_name"];?></a>
                <?php
                }
        ...
        <div class="compTable">
            <table>
                ...
                <tr>
                    <td>Processor</td>
                    <td><?php if($prod1==NULL) echo "--"; else echo "{$row1["processor"]}";?></td>
                    <td><?php if($prod2==NULL) echo "--"; else echo "{$row2["processor"]}";?></td>
                    <td><?php if($prod3==NULL) echo "--"; else echo "{$row3["processor"]}";?></td>
                </tr>
                <tr>
                    <td>Battery</td>
                ...
                <tr>
                    <td>RAM</td>
                    <td><?php if($prod1==NULL) echo "--"; else echo "{$row1["RAM"]}";?></td>
                    <td><?php if($prod2==NULL) echo "--"; else echo "{$row2["RAM"]}";?></td>
                    <td><?php if($prod3==NULL) echo "--"; else echo "{$row3["RAM"]}";?></td>
                </tr>
                <tr>
                    <td>SSD</td>
                    <td><?php if($prod1==NULL) echo "--"; else echo "{$row1["SSD"]}";?></td>
                    <td><?php if($prod2==NULL) echo "--"; else echo "{$row2["SSD"]}";?></td>
                    <td><?php if($prod3==NULL) echo "--"; else echo "{$row3["SSD"]}";?></td>
                </tr>
                <tr>
                    <td>Display</td>
                ...
                <tr>
                    <td>Audio</td>
                    <td><?php if($prod1==NULL) echo "--"; else echo "{$row1["audio"]}";?></td>
                    <td><?php if($prod2==NULL) echo "--"; else echo "{$row2["audio"]}";?></td>
                    <td><?php if($prod3==NULL) echo "--"; else echo "{$row3["audio"]}";?></td>
                </tr>
                <tr>
                    <td>Front Camera</td>
